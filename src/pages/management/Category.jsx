...
const Category = () => {
  ...
  const fetchData = async () => {
    const fetchedData = await getData("category");
    setData(fetchedData);
  };
          ...
          <Dialog
            ...
            PaperProps={{
              ...
              onSubmit: async (event) => {
                ...
                await postData("category", formJson);
                fetchData();
                    ...
                    <Dialog
                      ...
                      PaperProps={{
                        ...
                        onSubmit: async (event) => {
                          ...
                          await updateData("category", dataUpdate.id, formJson);
                          fetchData();
                    ...
                    >
                      ...
                      <DialogContent>
                        <TextField
                          ...
                          name="category_name"
                          label="category Name"
                          value={dataUpdate.category_name}
                          onChange={(e) => {
                            setDataUpdate({
                              ...dataUpdate,
