            ...
            <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <Link
                  ...
                  rel="noreferrer"
                  target="_blank"
                  class="text-blue-600 transition hover:text-blue-600/75"
                >
              ...
              <li>
                <Link
                  ...
                  rel="noreferrer"
                  target="_blank"
                  class="text-yellow-500 transition hover:text-yellow-500/75"
                >
              ...
              <li>
                <Link
                  ...
                  rel="noreferrer"
                  target="_blank"
                  class="text-red-500 transition hover:text-red-500/75"
                >
